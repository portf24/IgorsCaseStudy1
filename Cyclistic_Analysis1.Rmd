...
#### The dataset appears clean: functions glimpse() and skim_without_charts() reaffirms the data's integrity and readiness for the Analysis Phase
...
### Figure 1. Pie chart for trip number of members vs casuals in %.
```{r}
...
### Figure 2. Pie chart for trip number of all riders in %.
```{r}
...
- Note: Function 'month_to_season' will be used for Figure 11 and Table 3as well)
```{r}
...
### Figure 10. Trip count with data labels for all riders by seasons.
```{r}
...
### Figure 11. Trip duration with data labels for all riders by seasons.
```{r}
...
```{r}
# Step 1: Extract month and classify into seasons
data2023 <- data2023 %>%
  mutate(
...
### Figure 12. Weekly, Monthly, Yearly, Bike and Cold seasons ratios between Casuals and Members.
```{r}
...
- From calculation above: Includes 'yearly_avg_months'.
```{r}
